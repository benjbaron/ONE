...
public class ExternalMovementReader {
	 ...
	 */
	public List<Triplet<String, Coord, String>> readNextMovements() {
		ArrayList<Triplet<String, Coord, String>> moves =
			new ArrayList<Triplet<String, Coord, String>>();
		...
		while (scanner.hasNextLine() && lastTimeStamp == time) {
			...
			moves.add(new Triplet<String, Coord, String>(id, new Coord(x,y), state));
